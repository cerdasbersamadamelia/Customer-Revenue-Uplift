...
def main():
    ...
    tabs = ["Ranking & Targeting", "Campaign Simulation & What-If", "Network Influence Analysis", "Customer Segmentation", "Model Explainability"]
    selected_tab = st.sidebar.selectbox("Select Tab", tabs)
    
    # Tab 1: Ranking & Targeting
    if selected_tab == "Ranking & Targeting":
    ...
    elif selected_tab == "Campaign Simulation & What-If":
    ...
    elif selected_tab == "Network Influence Analysis":
    ...
    # Tab 5: Model Explainability
        ...
        # Create a bar chart for SHAP importance
        fig = px.bar(
            top10.head(10), 
            x='shap_importance', 
            y='fitur',
